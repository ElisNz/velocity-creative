      ...
      <div className="w-full h-fit flex flex-col items-center justify-center gap-2">
        <div className="w-full h-fit flex">
          ...
          <section className="flex-1">
            <h2 className="w-full capitalize text-left mb-2">{caseName}</h2>
            <p className="">A collaboration with Scandinavia’s leading business law firm, spanning years and shaping a photographic visual identity while building a tailored image bank. </p>
          </section>
        </div>
