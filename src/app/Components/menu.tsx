...
export default function Menu({ imagePromise }: { imagePromise?: any }) {
  ...
  return (
    <hgroup className="fixed w-full h-screen max-h-full flex flex-col justify-between px-4 md:px-8 py-[5vh] z-50">
      <h1 className="select-none max-md:w-full text-center max-md:align-middle md:text-[4rem] uppercase text-white max-md:self-center md:self-start bg-[#141215]/90 pb-2 pt-3 px-4 mb-2 text-nowrap">Velocity Creative</h1>
